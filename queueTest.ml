...
let test () : bool =
  ...
  enq 5 q;
  length q = 6
;; run_test "length non-empty longer" test

let test () : bool =
  let q = create () in
  enq 2 q;
  length q = 1
;; run_test "length singleton" test
...
let test () : bool =
  let q = from_list [2; 3; 4; 5] in
  contains 3 q
;; run_test "contains non-empty true" test

let test () : bool =
  let q = from_list [2; 3; 4; 5; 3] in
  contains 3 q
;; run_test "contains non-empty true multiple" test
...
let test () : bool =
  ...
  truncate 2 q;
  to_list q = [2]
;; run_test "truncate nonempty becomes singleton" test
...
let test () : bool =
  ...
  truncate 4 q;
  to_list q = [2; 3]
;; run_test "truncate nonempty, not in list" test
...
let test () : bool =
  ...
  truncate 3 q;
  to_list q = [2; 3]
;; run_test "truncate nonempty, multiple occurrences" test
...
let test () : bool =
  ...
  delete 2 q;
  to_list q = []
;; run_test "delete singleton becomes empty" test
...
let test () : bool =
  ...
  delete 5 q;
  to_list q = [2]
;; run_test "delete singleton no delete" test
...
let test () : bool =
  ...
  delete 2 q;
  to_list q = [5; 3; 4]
;; run_test "delete nonempty multiple occurrences" test
...
let test () : bool =
  ...
  enq 2 q;
  delete 4 q;
  to_list q = [3; 2; 3; 2; 3; 2]
;; run_test "delete nonempty no occurrences" test
